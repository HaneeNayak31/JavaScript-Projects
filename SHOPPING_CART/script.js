document.addEventListener("DOMContentLoaded", () => {
  ...
  productList.addEventListener("click", (e) => {
    // Only handle buttons that have a data-id (Add to cart buttons).
  ...
  // Local storage helpers: persist cart as JSON
  function saveCart() {
    try {
  ...
  loadCart();
  // Render loaded items so UI matches saved state
  renderCart();
  ...
  checkOutBtn.addEventListener("click", () => {
    ...
    try {
      ...
      console.warn("Could not remove cart from localStorage:", err);
    }
